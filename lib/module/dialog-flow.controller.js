...
let DialogFlowController = DialogFlowController_1 = class DialogFlowController {
    ...
    dialogFlowWebHook(dialogFlowResponse, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const fulfillment = yield this.dialogFlowService.handleIntentOrAction(dialogFlowResponse);
...
DialogFlowController = DialogFlowController_1 = __decorate([
    common_1.Controller(),
    __metadata("design:paramtypes", [dialog_flow_component_1.DialogFlowService])
