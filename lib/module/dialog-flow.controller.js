...
let DialogController = DialogController_1 = class DialogController {
    ...
    static forRoute(webHookConfig) {
        ...
        Reflect.defineMetadata(constant_1.METHOD_METADATA, enums_1.requestMethod.POST, Object.getOwnPropertyDescriptor(DialogController_1.prototype, 'dialogFlowWebHook').value);
    ...
    dialogFlowWebHook(dialogFlowResponse, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.status(common_1.HttpStatus.OK).send(fulfillment);
        });
    }
};
__decorate([
